package com.yinyuan.radarsdk.manager;

import gnu.io.*;
import com.yinyuan.radarsdk.utils.ArrayUtils;
...
public class SerialPortManager {
	...
	public static byte[] readFromPort(SerialPort serialPort) {
		...
		try {
			...
			//int bytesNum = in.read(bytes,0,in.available());
			int bytesNum = in.read(readBuffer);
			//System.out.println("in_length:"+in.available());
			while (bytesNum > 0) {
